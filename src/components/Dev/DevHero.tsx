        ...
        <div className="w-full">
          ...
          <div className="dev-animate mb-8 inline-flex items-center gap-2">
            <span
              ...
              style={{
                background: dark ? 'rgba(110,231,183,0.08)' : 'rgba(110,231,183,0.15)',
          ...
          {/* Typing text */}
          <p className={`dev-animate text-lg md:text-xl font-light leading-relaxed mb-10 max-w-2xl ${dark ? 'text-gray-400' : 'text-gray-600'}`}>
            Focused on creating fast, accessible, and beautifully crafted frontend
            experiences using{' '}
            <span
            ...
            {''}- writing clean, maintainable code that delivers seamless user experiences.
          </p>
          ...
          <div className="dev-animate flex flex-wrap gap-4">
            <a
              ...
              style={{ background: 'linear-gradient(135deg, #6EE7B7 0%, #3B82F6 50%, #8B5CF6 100%)' }}
            >
              View My Work
          ...
          <div className="dev-animate mt-16 flex flex-wrap gap-8">
            {[
              ...
              <div key={stat.label}>
                ...
                <p className={`text-sm mt-0.5 ${dark ? 'text-gray-500' : 'text-gray-500'}`}>{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
